      ...
      <form onSubmit={handleSubmit}>
        <fieldset>
          ...
          <div className="Field">
            ...
            <input placeholder="Password" type="password" value={password.value} onChange={(e)=>setPassword({...password,value:e.target.value})} onBlur={(e)=>setPassword({...password, isTouched:true})} />
